...
// LabaInterpolaziyaGauss.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CLabaInterpolaziyaGaussApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CLabaInterpolaziyaGaussApp

CLabaInterpolaziyaGaussApp::CLabaInterpolaziyaGaussApp()
{
...
// Единственный объект CLabaInterpolaziyaGaussApp

CLabaInterpolaziyaGaussApp theApp;


// Инициализация CLabaInterpolaziyaGaussApp

BOOL CLabaInterpolaziyaGaussApp::InitInstance()
{
	...
	CLabaInterpolaziyaGaussDlg dlg;
	m_pMainWnd = &dlg;
